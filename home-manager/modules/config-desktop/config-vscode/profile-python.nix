...
in {
  programs.vscode.profiles.python.extensions = with pkgsExt.vscode-marketplace; [
    astral-sh.ty
    charliermarsh.ruff
  ...
  programs.vscode.profiles.python.userSettings = {
    # === Appearance ===
  ...
  programs.vscode.profiles.python.keybindings = [
    {
      key = "ctrl+h";
